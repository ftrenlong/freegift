        ...
        if ($('pickupatstore_days').value != '') {
            ...
            PickupAtStore.hours.each(function(h) {
                ...
                if (PickupAtStore.datetime[ $('pickupatstore_days').value][0] <= h.value && h.value <= PickupAtStore.datetime[ $('pickupatstore_days').value][1]) {
                    ...
                    if ( typeof PickupAtStore.datetime[ $('pickupatstore_days').value][2] == "undefined" || (h.value < PickupAtStore.datetime[ $('pickupatstore_days').value][2] || PickupAtStore.datetime[ $('pickupatstore_days').value][3] <= h.value)) {
