...
class Wyomind_Advancedinventory_Block_Adminhtml_Pointofsale_Edit_Tab_AdvancedInventory extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm() 
    {
        ...
        if (Mage::getStoreConfig("advancedinventory/setting/autoassign_order")) {
            ...
            $fieldset->addField(
                'use_assignation_rules', 'select', array(
            ...
            $fieldset->addField(
                'inventory_assignation_rules', 'textarea', array(
            ...
            $fieldset->addField(
                'inventory_notification', 'text', array(
        ...
        $fieldset->addField(
            'default_stock_management', 'select', array(
        ...
        $fieldset->addField(
            'default_use_default_setting_for_backorder', 'select', array(
        ...
        $fieldset->addField(
            'default_allow_backorder', 'select', array(
