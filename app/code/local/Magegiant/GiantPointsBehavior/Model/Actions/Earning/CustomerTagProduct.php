 ...
 */
class Magegiant_GiantPointsBehavior_Model_Actions_Earning_CustomerTagProduct
    ...
    implements Magegiant_GiantPoints_Model_Actions_Interface
{
    ...
    public function getComment()
    {
        ...
        return Mage::helper('giantpoints')->__('Reward for tagging product %s', $actonObj->getProductName());
    }
