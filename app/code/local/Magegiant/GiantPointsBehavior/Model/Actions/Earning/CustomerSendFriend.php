 ...
 */
class Magegiant_GiantPointsBehavior_Model_Actions_Earning_CustomerSendFriend
    ...
    implements Magegiant_GiantPoints_Model_Actions_Interface
{
    ...
    public function getComment()
    {
        ...
        return Mage::helper('giantpoints')->__('Reward for sent "%s" to friends', $actonObj->getProductName());
    }
