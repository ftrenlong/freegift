 ...
 */
class Magegiant_GiantPointsRefer_Block_Checkout_Cart_Renderer_Point extends Mage_Checkout_Block_Total_Default
{
    ...
    {
        return Mage::helper('giantpointsrefer')->getPointForInvitee(Mage::helper('giantpoints/customer')->getCustomer());
    }

    public function customerIsGuest()
    {
        return $this->getCustomer()->getId() ? false : true;
    }
