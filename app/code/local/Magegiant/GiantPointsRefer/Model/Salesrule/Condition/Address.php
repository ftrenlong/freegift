 ...
 */
class Magegiant_GiantPointsRefer_Model_Salesrule_Condition_Address extends Mage_Rule_Model_Condition_Abstract
{
    ...
    public function validate(Varien_Object $object)
    {
        ...
        if (in_array($this->getAttribute(), $addressAttributes)) {
            ...
            try {
                ...
                Mage::helper('giantpoints')->log('Exception: ' . 'Exception: ' . $e->getMessage() . ' in ' . __CLASS__ . ' on line ' . __LINE__ . ' in ' . __CLASS__ . ' on line ' . __LINE__);
            }
        }
