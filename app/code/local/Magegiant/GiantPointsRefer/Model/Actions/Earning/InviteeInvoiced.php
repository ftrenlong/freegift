 ...
 */
class Magegiant_GiantPointsRefer_Model_Actions_Earning_InviteeInvoiced
    ...
    implements Magegiant_GiantPoints_Model_Actions_Interface
{
    ...
    public function getComment()
    {
        ...
        return Mage::helper('giantpoints')->__('Earn points for you invited purchasing order #%s via referring', $order->getIncrementId());
    }
    ...
    public function getCommentHtml($transaction = null)
    {
        ...
        return Mage::helper('giantpoints')->__(
            'Earn points for you invited purchasing order #%s via referring',
    ...
    public function updateTransaction()
    {
        ...
        $expireDays                         = Mage::helper('giantpointsrefer/config')->getPointsCommissionDayLimit();
        $expireTime                         = $expireDays * 86400 + Mage::helper('giantpoints')->getMageTime();
        $transactionData['expiration_date'] = $expireTime;
