...
class Magegiant_GiantPoints_Helper_Action extends Mage_Core_Helper_Abstract
{
     ...
     * @throws Exception
     */
    public function createTransaction($action_code, $additionalData = array('action_object' => null, 'customer' => null, 'notice' => array()),$points = null)
    {
        ...
        try {
            if($points){
                $pointAmount =   (int)$points;
            }else{
                $pointAmount = (int)$actionModel->getPointAmount();
            }
