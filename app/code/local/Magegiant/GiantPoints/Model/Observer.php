...
class Magegiant_GiantPoints_Model_Observer
{
    ...
    public function salesOrderPlaceAfter($observer)
    {
        ...
        if ($order->getGiantpointsEarn() && !Mage::app()->getStore()->isAdmin() && $order->getState() != Mage_Sales_Model_Order::STATE_COMPLETE) {
    ...
    protected function _processRewrite()
    {
        ...
        if (!Mage::helper('giantpoints/version')->isEnterprise() && !Mage::helper('giantpoints/version')->isRawVerAtLeast('1.8.0.0')) {
