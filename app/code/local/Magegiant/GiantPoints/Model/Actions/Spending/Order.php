 ...
 */
class Magegiant_GiantPoints_Model_Actions_Spending_Order
    extends Magegiant_GiantPoints_Model_Actions_Abstract
    implements Magegiant_GiantPoints_Model_Actions_Interface
{
    protected $_actionType = Magegiant_GiantPoints_Model_Actions_Abstract::GIANTPOINTS_ACTION_TYPE_SPENDING;
    ...
    public function getPointAmount()
    {
        ...
        return -(int)$order->getGiantpointsSpent();
    }
    ...
    public function getComment()
    {
        ...
        return Mage::helper('giantpoints')->__('Spend points to purchase order #%s', $order->getIncrementId());
    }
