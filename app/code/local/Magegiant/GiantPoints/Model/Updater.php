...
class Magegiant_GiantPoints_Model_Updater
{
    ...
    const EARNING_INFO_BLOCK_NAME = 'checkout.cart.earning';
    const ONEPAGE_PAYMENT_METHOD_BLOCK_NAME = 'root';
    const GIANT_ONESTEP_PAYMENT_METHOD_BLOCK_NAME = 'one.step.checkout.container.form.payment.method';
    const GIANT_ONESTEP_REVIEW_CART_BLOCK_NAME    = 'one.step.checkout.container.form.review.items';
    ...
    protected $_map = array(
        'applyPoint'            => array(
            ...
            'earning_info' => self::EARNING_INFO_BLOCK_NAME,
        ),
        ...
        'applyPointFireOnestep' => array(
            'review_payment' => 'checkout.payment.method',
            'review_cart'    => 'checkout.review',
        ),
    );
