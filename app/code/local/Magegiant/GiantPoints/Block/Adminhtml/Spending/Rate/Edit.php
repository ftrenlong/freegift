 ...
 */
class Magegiant_GiantPoints_Block_Adminhtml_Spending_Rate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('points_rate_data')
            ...
            return Mage::helper('giantpoints')->__("Edit Spending Rate #%s",
                                                $this->htmlEscape(Mage::registry('points_rate_data')->getId())
            );
        }
        return Mage::helper('giantpoints')->__('Add Spending Rate');
    }
}