 ...
 */
class Magegiant_GiantPoints_Block_Adminhtml_Spending_Rate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('spendingrateGrid');
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('giantpoints/rate_collection')
            ->addFieldToFilter('direction', Magegiant_GiantPoints_Model_Rate::POINT_TO_MONEY);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('points', array(
            'header' => Mage::helper('giantpoints')->__('Spending Point(s)'),
            'align'  => 'left',
            'index'  => 'points',
            'type'   => 'number',
        ));
        $this->addColumn('money', array(
            'header'   => Mage::helper('giantpoints')->__('Discount received'),
            'align'    => 'right',
            'index'    => 'money',
            'type'     => 'number',
