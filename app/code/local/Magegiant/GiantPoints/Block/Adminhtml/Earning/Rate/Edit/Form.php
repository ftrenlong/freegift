 ...
 */
class Magegiant_GiantPoints_Block_Adminhtml_Earning_Rate_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            'base_fieldset',
            array(
                'legend' => $helper->__('Earning Rate Information'),
            )
        );
    ...
    {
        return Magegiant_GiantPoints_Model_Rate::MONEY_TO_POINT;
    }
