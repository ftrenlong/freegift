...
class Magegiant_GiantPoints_Block_Checkout_Onepage_Payment_Spending extends Magegiant_GiantPoints_Block_Abstract
{
    ...
    public function getApplyPointUrl()
    {
        $isSecure = Mage::app()->getStore()->isCurrentlySecure();

        return $this->getUrl('giantpoints/ajax/applyPointOnepage', array('_secure' => $isSecure));

    }

    public function getApplyPointOneStepUrl()
    {
        $isSecure = Mage::app()->getStore()->isCurrentlySecure();

        return $this->getUrl('giantpoints/ajax/applyPointOnestep', array('_secure' => $isSecure));
    }

    public function getApplyPointFireUrl()
    {
        $isSecure = Mage::app()->getStore()->isCurrentlySecure();

        return $this->getUrl('giantpoints/ajax/applyPointFireOnestep', array('_secure' => $isSecure));
    }
