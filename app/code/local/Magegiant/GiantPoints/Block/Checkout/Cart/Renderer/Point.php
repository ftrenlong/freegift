...
class Magegiant_GiantPoints_Block_Checkout_Cart_Renderer_Point extends Mage_Checkout_Block_Total_Default
{
    ...
    {
        return Mage::helper('giantpoints/calculation_spending')->getTotalSpendingPoints($quote);
    }
    ...
    {
        return Mage::helper('giantpoints/calculation_earning')->getEarnedPointsSummary();
    }
