 ...
 */
class Magegiant_GiantPoints_Adminhtml_Giantpoints_Earning_RateController extends Mage_Adminhtml_Controller_Action
{
    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('giantpoints/earning/earning_rate')
            ->_addBreadcrumb(
    ...
    public function editAction()
    {
        ...
        if ($model->getId() || $rateId == 0) {
            ...
            $this->_addContent($this->getLayout()->createBlock('giantpoints/adminhtml_earning_rate_edit'));
            $this->renderLayout();
        } else {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    Mage::helper('giantpoints')->__('Earning rate was successfully saved')
                );
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('giantpoints/earning/earning_rate');
    }
}